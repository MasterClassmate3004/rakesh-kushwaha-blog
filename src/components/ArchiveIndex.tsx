    ...
    return (
        <div className="space-y-6 md:space-y-8">
            <section className="glass-card rounded-3xl p-4 md:p-6 border border-white/10 md:sticky md:top-20 z-20">
                <div className="flex items-center gap-3 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-black/30 shadow-[inset_0_1px_0_rgba(255,255,255,0.85)] dark:shadow-none px-4 py-3">
