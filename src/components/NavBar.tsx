                    ...
                    >
                        ...
                        {isSearchOpen && (
                            <motion.div
                                ...
                                className="absolute top-12 left-0 w-full rounded-2xl p-2.5 border border-slate-300/70 dark:border-white/15 bg-white/95 dark:bg-[#090b10] shadow-[0_20px_40px_rgba(15,23,42,0.12)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.6)]"
                            >
